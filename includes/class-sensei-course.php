            ...
            if ( $completed_course ) { ?>
                ...
                if( has_filter( 'sensei_results_links' ) || $has_quizzes ) { ?>
                    <p class="sensei-results-links">
                        ...
                        echo $results_link;
                        ?><?php echo "<div id='elearnbutton'><a id='backtoelearn' class='dt-sc-button small filled' href='../../courses-overview/#tabs-41968-0-1'>Back to e-learning</a></div>";?></p>
                <?php } ?>
            <?php } else { ?>
                <div class="status in-progress"><?php echo __( 'In Progress', 'woothemes-sensei' ); ?></div>
                <?php echo "<div id='elearnbutton'><a id='backtoelearn' class='dt-sc-button small filled' href='../../courses-overview/#tabs-41968-0-1'>Back to e-learning</a></div>";?>
            <?php }
